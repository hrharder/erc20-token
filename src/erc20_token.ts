...
export class ERC20Token {
    public static UNLIMITED_ALLOWANCE = new BigNumber(MAX_ALLOWANCE);
     ...
     */
    constructor(provider: SupportedProvider, callAndTxDefaults?: Partial<CallData>) {
        this._tokenContracts = {};
        this._provider = provider;
        this._web3 = new Web3Wrapper(this._provider, callAndTxDefaults);
